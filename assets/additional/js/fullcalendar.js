! function (e, t) {
    ...
    function xe(e, t, n) {
        ...
        for (var p in c) {
            var h = c[p];
            if (h.recurringDef)
                for (var f = (f = h.recurringDef.duration) || (h.allDay ? n.defaultAllDayEventDuration : n.defaultTimedEventDuration), v = 0, g = (r = h, i = f, o = t, s = n.dateEnv, a = n.pluginSystem.hooks.recurringTypes, l = void 0, l = a[r.recurringDef.typeId].expand(r.recurringDef.typeData, {
    ...
    var ut = (pt.prototype.setProp = function (e, t) {
        var n, r, i;
        e in Vt || (e in Bt ? ("function" == typeof Bt[e] && (t = Bt[e](t)), this.mutate({
            standardProps: ((n = {})[e] = t, n)
        })) : e in Ht && (i = void 0, "function" == typeof Ht[e] && (t = Ht[e](t)), i = "color" === e ? {
            backgroundColor: t,
            borderColor: t
        } : "editable" === e ? {
            startEditable: t,
        ...
        var n, r = this._calendar.dateEnv,
            i = r.createMarker(e);
        i && this._instance && (n = ge(this._instance.range.start, i, r, t.granularity), t.maintainDuration ? this.mutate({
            datesDelta: n
        }) : this.mutate({
            startDelta: n
        }))
        ...
        (null == e || (n = i.createMarker(e))) && this._instance && (n ? (r = ge(this._instance.range.end, n, i, t.granularity), this.mutate({
            endDelta: r
        })) : this.mutate({
            standardProps: {
                hasEnd: !1
    ...
    var Dn = 0,
        Tn = (Cn.prototype.extend = function (e, t) {
    ...
    var kn, xn = (ye(Mn, kn = Rn), Mn.prototype.destroy = function () {
    ...
    }, Mn.prototype.buildPositionCaches = function () {}, Mn.prototype.queryHit = function (e, t, n, r) {
        return null
        ...
        var t = this.context.calendar,
            n = this.props.dateProfile;
        return !(n && !Fe(n.validRange, e.range)) && Ct({
            dateSelection: e
        }, t)
    ...
    function Yn(e) {
        for (var t = 0 < e.length ? e[0].code : "en", n = window.FullCalendarLocalesAll || [], r = window.FullCalendarLocales || {}, i = n.concat(Ce(r), e), o = {
                en: qn
    ...
    var or = (sr.prototype.createMarker = function (e) {
        ...
        return null !== o ? {
            ...
            unit: "minute",
            value: o
        } : (i = e, de(o = (t.valueOf() - i.valueOf()) / 1e3) ? {
            unit: "second",
            value: o
        } : {
            unit: "millisecond",
    ...
    var Mr, Pr = (ye(Hr, Mr = Rn), Hr.prototype.render = function (e, t) {
        ...
        this.updateElClassNames(e), m(this.el, this.contentEl = s("div", {
        ...
        d ? (o || (o = this.header = new kr("fc-header-toolbar"), m(this.el, o.el)), o.receiveProps(Se({
            layout: d
        }, g), i)) : o && (o.destroy(), o = this.header = null), c ? (s || (s = this.footer = new kr("fc-footer-toolbar"), b(this.el, s.el)), s.receiveProps(Se({
            layout: c
        }, g), i)) : s && (s.destroy(), s = this.footer = null)
    ...
    rn.mixInto(Yr);
    var ni, ri = (ye(ii, ni = xn), ii.prototype.initialize = function () {}, Object.defineProperty(ii.prototype, "activeStart", {
        get: function () {
    ...
    }, ii.prototype.renderEventResize = function (e) {}, ii.prototype.unrenderEventResize = function (e) {}, ii.prototype.startNowIndicator = function (e, t) {
        var n, r, i, o = this,
            s = this.context,
            a = s.calendar,
            l = s.dateEnv;
    ...
    }, ii.prototype.getNowIndicatorUnit = function (e, t) {}, ii.prototype.renderNowIndicator = function (e) {}, ii.prototype.unrenderNowIndicator = function () {}, ii.prototype.addScroll = function (e, t) {
    ...
    function ii(e, t) {
        var n = ni.call(this, s("div", {
            className: "fc-view fc-" + e.type + "-view"
        })) || this;
    ...
    function mi(e, t, n, r, i, o, s, a) {
        ...
        return n ? p = p.concat(Qt(e, t, o, !0)) : p.push("fc-" + H[e.getUTCDay()]), '<th class="' + p.join(" ") + '"' + (u && n ? ' data-date="' + l.formatIso(e, {
            omitTime: !0
        }) + '"' : "") + (1 < s ? ' colspan="' + s + '"' : "") + (a ? " " + a : "") + ">" + (u ? Jt(c, l, {
            date: e,
            forceOff: !n || 1 === r
        }, h) : h) + "</th>"
    }
...
function (e, t) {
        ...
        for (n = 0; n < h; n++) {
            if (r = p[n], i = 0, o = document.createElement("tr"), v.push([]), g.push([]), m.push([]), r)
                for (s = 0; s < r.length; s++) {
                    ...
                    for (y(S), l = R.createElement("td", {
                            className: "fc-event-container"
                        }, a.el), S !== E ? l.colSpan = E - S + 1 : m[n][i] = l; i <= E;) g[n][i] = l, v[n][i] = a, i++;
                    o.appendChild(l)
                }
            y(u);
    ...
    var M = (P.prototype.renderHtml = function (e) {
        ...
        for (var n, r, i, o, s, a, l, d, c = 0, u = e.cells; c < u.length; c++) {
            var p = u[c];
            t.push((n = p.date, r = e.dateProfile, i = this.context, o = p.htmlAttrs, d = l = a = s = void 0, s = i.dateEnv, a = i.theme, l = R.rangeContainsMarker(r.activeRange, n), (d = R.getDayClasses(n, r, i)).unshift("fc-day", a.getClass("widgetContent")), '<td class="' + d.join(" ") + '"' + (l ? ' data-date="' + s.formatIso(n, {
                omitTime: !0
            }) + '"' : "") + (o ? " " + o : "") + "></td>"))
        }
    ...
    var H, _ = R.createFormatter({
        ...
        z = (t(N, H = R.DateComponent), N.prototype.render = function (e, t) {
            ...
            for (this.el.innerHTML = c, this.rowEls = R.findElements(this.el, ".fc-row"), this.cellEls = R.findElements(this.el, ".fc-day, .fc-disabled-day"), s && this.cellEls.reverse(), this.rowPositions = new R.PositionCache(this.el, this.rowEls, !1, !0), this.colPositions = new R.PositionCache(this.el, this.cellEls.slice(0, d), !0, !1), u = 0; u < l; u++)
                for (n = 0; n < d; n++) i.publiclyTrigger("dayRender", [{
            ...
            return l || this.renderProps.cellWeekNumbersVisible ? ((t = R.getDayClasses(e, this.props.dateProfile, this.context)).unshift("fc-day-top"), this.renderProps.cellWeekNumbersVisible && (n = i.weekDow), s += '<td class="' + t.join(" ") + '"' + (a ? ' data-date="' + i.formatIso(e, {
                omitTime: !0
            }) + '"' : "") + ">", this.renderProps.cellWeekNumbersVisible && e.getUTCDay() === n && (s += R.buildGotoAnchorHtml(o, i, {
                date: e,
                type: "week"
            }, {
                class: "fc-week-number"
            }, i.format(e, O))), l && (s += R.buildGotoAnchorHtml(o, i, e, {
                class: "fc-day-number"
            }, i.format(e, _))), s += "</td>") : "<td></td>"
    ...
    var L, B = R.createFormatter({
            week: "numeric"
        }),
        V = (t(F, L = R.View), F.prototype._processOptions = function (e) {
    ...
    e.AbstractDayGridView = V, e.DayBgRow = M, e.DayGrid = z, e.DayGridSlicer = j, e.DayGridView = Y, e.SimpleDayGrid = U, e.buildBasicDayTable = K, e.default = J, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}),
function (e, t) {
    ...
    }, o.prototype.detachSegs = function () {}, o.prototype.renderSegHtml = function (e) {
        var t = this.context,
            n = t.theme,
            r = t.options,
            i = e.eventRange,
    ...
    var s, a = (t(l, s = p.View), l.prototype.firstContext = function (e) {
        ...
        for (var n, r, i = this.context, o = i.dateEnv, s = i.nextDayThreshold, a = e.range, l = e.def.allDay, d = [], c = 0; c < t.length; c++)
            if ((n = p.intersectRanges(a, t[c])) && (r = {
                    component: this,
                    eventRange: e,
                    start: n.start,
                    end: n.end,
        ...
        return p.createElement("tr", {
            ...
            "data-date": r.formatIso(e, {
                omitTime: !0
            })
        }, '<td class="' + (n.getClass("tableListHeading") || n.getClass("widgetHeader")) + '" colspan="3">' + (o ? p.buildGotoAnchorHtml(i, r, e, {
            class: "fc-list-heading-main"
        }, p.htmlEscape(r.format(e, o))) : "") + (s ? p.buildGotoAnchorHtml(i, r, e, {
            class: "fc-list-heading-alt"
        }, p.htmlEscape(r.format(e, s))) : "") + "</td>")
    }, l);
    ...
    e.ListView = a, e.default = c, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}),
function (e, t) {
    ...
    var m, y = [{
        ...
        S = (t(E, m = g.DateComponent), E.prototype._processOptions = function (e) {
            ...
            if (this.colContainerEls) {
                ...
                0 < e.length && ((n = g.createElement("div", {
                    className: "fc-now-indicator fc-now-indicator-arrow"
                })).style.top = r + "px", this.contentSkeletonEl.appendChild(n), i.push(n)), this.nowIndicatorEls = i
            }
    ...
    var T, C = g.createFormatter({
            week: "short"
        }),
        R = (t(I, T = g.View), I.prototype.render = function (e, t) {
    ...
    e.AbstractTimeGridView = R, e.TimeGrid = S, e.TimeGridSlicer = _, e.TimeGridView = N, e.buildDayRanges = P, e.buildDayTable = B, e.default = V, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});